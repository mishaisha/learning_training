...
2) Claude Architect : [https://mishaisha.github.io/learning_training/aws_aif/AWS_AIF_C01_Learning_Tool.html](https://mishaisha.github.io/learning_training/anthropic_cca_f/CCA_F_Learning_Tool.html)
3) AWS CCP  :
4) AWS DVA : 
